var skwasm = (() => {
    ...
    return (
        function (skwasm) {
            ...
            var ka = Object.assign, la, ma;
            y.ready = new Promise(function (a, b) {
                la = a;
                ma = b
            });
            var na = ka({}, y), oa = "./this.program", pa = (a, b) => {
                    throw b;
                }, qa = "object" === typeof window, z = "function" === typeof importScripts,
                A = "object" === typeof process && "object" === typeof process.versions && "string" === typeof process.versions.node,
                B = y.ENVIRONMENT_IS_PTHREAD || !1, D = "";
            ...
            var za = console.log.bind(console), Aa = console.warn.bind(console);
            A && (wa(), za = a => fs.writeSync(1, a + "\n"), Aa = a => fs.writeSync(2, a + "\n"));
            var Ba = y.print || za, E = y.printErr || Aa;
            ka(y, na);
            na = null;
            ...
            if (B) h = y.wasmMemory, l = y.buffer; else if (y.wasmMemory) h = y.wasmMemory; else if (h = new WebAssembly.Memory({
                initial: Ra / 65536,
                maximum: 32768,
                shared: !0
            ...
            var H = 0, Ya = null, Za = null;
            y.preloadedImages = {};
            y.preloadedAudios = {};

            function Fa(a) {
                if (B) postMessage({cmd: "onAbort", arg: a}); else if (y.onAbort) y.onAbort(a);
                a = "Aborted(" + a + ")";
                E(a);
                Ha = !0;
            ...
            function bb() {
                if (!Ea && (qa || z)) {
                    if ("function" === typeof fetch && !I.startsWith("file://")) return fetch(I, {credentials: "same-origin"}).then(function (a) {
            ...
            var M = {
                j: [], D: [], U: [], sa: function () {
                    ...
                    a.onmessage = c => {
                        ...
                        if (c.targetThread && c.targetThread != jb()) {
                        ...
                        } else if ("processQueuedMainThreadWork" === d) kb(); else if ("spawnThread" === d) lb(c); else if ("cleanupThread" ===
                            ...
                            c.target) a.postMessage(c); else if ("onAbort" === d) {
            ...
            function lb(a) {
                ...
                if (!b) return 6;
                M.D.push(b);
                var c = M.i[a.S] = {worker: b, T: a.S};
                b.s = c;
                var d = {cmd: "run", start_routine: a.Ea, arg: a.A, threadInfoStruct: a.S};
                d.o = a.o;
                d.M = a.M;
                b.C = () => {
            ...
            function yb(a, b, c, d, f, g) {
                if (B) b = O(5, 1, a, b, c, d, f, g); else if (g <<= 12, 0 !== (d & 16) && 0 !== a % 65536) b = -28; else if (0 !== (d & 32)) {
                    var k = 65536 * Math.ceil(b / 65536);
                    (a = zb(65536, k)) ? r().fill(0, a, a + k) : a = 0;
                    a ? (sb[a] = {va: a, ua: b, ja: !0, fd: f, Qa: c, flags: d, offset: g}, b = a) : b = -48
                } else b = -52;
                return b
            }

            function Ab(a, b) {
                if (B) a = O(6, 1, a, b); else {
                    var c = sb[a];
            ...
            var Gb = 1, Hb = [], P = [], Ib = [], Jb = [], Kb = [], Q = [], R = [], Lb = {}, N = {}, Mb = [], Nb = [],
                Ob = {}, Pb = {}, Qb = 4;
            ...
            function Ub(a, b) {
                var c = Vb(8);
                u()[c + 4 >> 2] = jb();
                var d = {Na: c, attributes: b, version: b.ba, v: a};
            ...
            function cc(a, b, c, d, f) {
                a = bc(a);
                var g = 31 - Math.clz32(a.BYTES_PER_ELEMENT), k = Qb;
            ...
            function kc(a, b, c) {
                ...
                if (d.l || !d.I) d.l && (d = d.l), a = !1, d.H && d.H.v && (a = d.H.v.getParameter(2978), a = 0 === a[0] && 0 === a[1] && a[2] === d.width && a[3] === d.height), d.width = b, d.height = c, a && d.H.v.viewport(0, 0, b, c); else return d.g ? (d = u()[d.g + 8 >> 2], a = a ? F(a) : "", hc(d, a, b, c), 1) : -4;
                return 0
            }
            ...
            function Dc(a, b) {
                for (a = new Date(a.getTime()); 0 < b;) {
                    var c = a.getMonth(), d = (zc(a.getFullYear()) ? Bc : Cc)[c];
            ...
            function Ec(a, b, c, d) {
                ...
                function p(m) {
                    ...
                    var x = new Date(m.getFullYear() + 1, 0, 4), C = n(new Date(m.getFullYear(), 0, 4));
                    x = n(x);
                ...
                t = {
                    "%a": function (m) {
                        ...
                        var x = new Date(m.h + 1900, 0, 1), C = 0 === x.getDay() ? x : Dc(x, 7 - x.getDay());
                        ...
                        var x = new Date(m.h + 1901, 0, 4), C = n(new Date(m.h + 1900, 0, 4));
                        x = n(x);
            ...
            var bd = {
                ...
                __emscripten_thread_cleanup: function (a) {
                    B ? postMessage({cmd: "cleanupThread", thread: a}) : fb(a)
                },
                __pthread_create_js: function (a, b, c, d) {
                    ...
                    var f = [], g = 0, k = b ? u()[b + 40 >> 2] : 0;
                    -1 ==
                    k ? k = "#canvas" : k && (k = F(k).trim());
                    k && (k = k.split(","));
                    var n = {}, p = y.canvas ? y.canvas.id : "", t;
                    for (t in k) {
                        var v = k[t].trim();
                        try {
                            if ("#canvas" == v) {
                            ...
                            if (N[v]) {
                                ...
                                if (G.transferControlToOffscreen) G.g || (G.g = Vb(12), u()[G.g >> 2] = G.width, u()[G.g + 4 >> 2] = G.height, u()[G.g + 8 >> 2] = 0), Y = {
                                    ...
                                    g: G.g,
                                    id: G.id
                                }, G.I = !0; else return E('pthread_create: cannot transfer control of canvas "' + v + '" to pthread, because current browser does not support OffscreenCanvas!'), E("pthread_create: Build with -s OFFSCREEN_FRAMEBUFFER=1 to enable fallback proxying of GL commands from pthread to main thread."),
                                    52
                            }
                ...
                _emscripten_notify_thread_queue: function (a, b) {
                    if (a == b) postMessage({cmd: "processQueuedMainThreadWork"}); else if (B) postMessage({
                        targetThread: a,
                ...
                clock_gettime: function (a, b) {
                    if (0 === a) a = Date.now(); else if (1 === a || 4 === a) a = pb(); else return u()[Mc() >> 2] = 28, -1;
                    u()[b >> 2] = a / 1E3 | 0;
                    u()[b + 4 >> 2] = a % 1E3 * 1E6 | 0;
                    return 0
                },
                ...
                emscripten_glGetProgramiv: function (a, b, c) {
                    if (c) if (a >= Gb) S(1281); else if (a = P[a], 35716 == b) a = U.getProgramInfoLog(a), null === a && (a = "(unknown error)"), u()[c >> 2] = a.length + 1; else if (35719 == b) {
                        if (!a.L) for (b = 0; b < U.getProgramParameter(a, 35718); ++b) a.L = Math.max(a.L, U.getActiveUniform(a, b).name.length + 1);
                        u()[c >>
                        2] = a.L
                    } else if (35722 == b) {
                        if (!a.J) for (b = 0; b < U.getProgramParameter(a, 35721); ++b) a.J = Math.max(a.J, U.getActiveAttrib(a, b).name.length + 1);
                        u()[c >> 2] = a.J
                    } else if (35381 == b) {
                        if (!a.K) for (b = 0; b < U.getProgramParameter(a, 35382); ++b) a.K = Math.max(a.K, U.getActiveUniformBlockName(a, b).length + 1);
                        u()[c >> 2] = a.K
                    } else u()[c >> 2] = U.getProgramParameter(a, b); else S(1281)
                },
                ...
                emscripten_glGetUniformLocation: function (a, b) {
                    ...
                    if (a = P[a]) {
                        var c =
                            a, d = c.G, f = c.ia, g;
                        if (!d) for (c.G = d = {}, c.ha = {}, g = 0; g < U.getProgramParameter(c, 35718); ++g) {
                ...
                emscripten_glReadPixels: function (a, b, c, d, f, g, k) {
                    if (2 <= T.version) if (U.R) U.readPixels(a,
                        b, c, d, f, g, k); else {
                        var n = bc(g);
                ...
                emscripten_glTexImage2D: function (a, b, c, d, f, g, k, n, p) {
                    if (2 <= T.version) if (U.m) U.texImage2D(a, b, c, d, f, g, k, n, p); else if (p) {
                        var t = bc(n);
                        U.texImage2D(a, b, c, d, f, g, k, n, t, p >> 31 - Math.clz32(t.BYTES_PER_ELEMENT))
                    } else U.texImage2D(a, b, c, d, f, g, k, n, null); else U.texImage2D(a, b, c, d, f, g, k, n, p ? cc(n, k, d, f, p) :
                        null)
                },
                ...
                emscripten_glTexSubImage2D: function (a, b, c, d, f, g, k, n, p) {
                    if (2 <= T.version) if (U.m) U.texSubImage2D(a, b, c, d, f, g, k, n, p); else if (p) {
                        var t =
                            bc(n);
                        U.texSubImage2D(a, b, c, d, f, g, k, n, t, p >> 31 - Math.clz32(t.BYTES_PER_ELEMENT))
                    } else U.texSubImage2D(a, b, c, d, f, g, k, n, null); else t = null, p && (t = cc(n, k, f, g, p)), U.texSubImage2D(a, b, c, d, f, g, k, n, t)
                },
                emscripten_glUniform1f: function (a, b) {
                    U.uniform1f(V(a), b)
                },
                emscripten_glUniform1fv: function (a, b, c) {
                    if (2 <= T.version) U.uniform1fv(V(a), w(), c >> 2, b); else {
                        if (288 >= b) for (var d = W[b - 1], f = 0; f < b; ++f) d[f] = w()[c + 4 * f >> 2]; else d = w().subarray(c >> 2, c + 4 * b >> 2);
                        U.uniform1fv(V(a), d)
                    }
                },
                ...
                emscripten_glUniform1iv: function (a, b, c) {
                    if (2 <= T.version) U.uniform1iv(V(a), u(), c >> 2, b); else {
                        if (288 >= b) for (var d = dc[b - 1], f = 0; f < b; ++f) d[f] = u()[c + 4 * f >> 2]; else d = u().subarray(c >> 2, c + 4 * b >> 2);
                        U.uniform1iv(V(a), d)
                    }
                },
                ...
                emscripten_glUniform2fv: function (a, b, c) {
                    if (2 <= T.version) U.uniform2fv(V(a), w(), c >> 2, 2 * b); else {
                        if (144 >= b) for (var d = W[2 * b - 1], f = 0; f < 2 * b; f += 2) d[f] = w()[c + 4 * f >> 2], d[f + 1] = w()[c + (4 * f + 4) >> 2]; else d = w().subarray(c >> 2, c + 8 * b >> 2);
                        U.uniform2fv(V(a),
                            d)
                    }
                },
                ...
                emscripten_glUniform2iv: function (a, b, c) {
                    if (2 <= T.version) U.uniform2iv(V(a), u(), c >> 2, 2 * b); else {
                        if (144 >= b) for (var d = dc[2 * b - 1], f = 0; f < 2 * b; f += 2) d[f] = u()[c + 4 * f >> 2], d[f + 1] = u()[c + (4 * f + 4) >> 2]; else d = u().subarray(c >> 2, c + 8 * b >> 2);
                        U.uniform2iv(V(a), d)
                    }
                },
                ...
                emscripten_glUniform3fv: function (a, b, c) {
                    if (2 <= T.version) U.uniform3fv(V(a), w(), c >> 2, 3 * b); else {
                        if (96 >= b) for (var d = W[3 * b - 1], f = 0; f < 3 *
                        b; f += 3) d[f] = w()[c + 4 * f >> 2], d[f + 1] = w()[c + (4 * f + 4) >> 2], d[f + 2] = w()[c + (4 * f + 8) >> 2]; else d = w().subarray(c >> 2, c + 12 * b >> 2);
                        U.uniform3fv(V(a), d)
                    }
                },
                ...
                emscripten_glUniform3iv: function (a, b, c) {
                    if (2 <= T.version) U.uniform3iv(V(a), u(), c >> 2, 3 * b); else {
                        if (96 >= b) for (var d = dc[3 * b - 1], f = 0; f < 3 * b; f += 3) d[f] = u()[c + 4 * f >> 2], d[f + 1] = u()[c + (4 * f + 4) >> 2], d[f + 2] = u()[c + (4 * f + 8) >> 2]; else d = u().subarray(c >> 2, c + 12 * b >> 2);
                        U.uniform3iv(V(a), d)
                    }
                },
                ...
                emscripten_glUniform4fv: function (a, b, c) {
                    if (2 <= T.version) U.uniform4fv(V(a), w(), c >> 2, 4 * b); else {
                        if (72 >= b) {
                            var d = W[4 * b - 1], f = w();
                            c >>= 2;
                ...
                emscripten_glUniform4iv: function (a, b, c) {
                    if (2 <= T.version) U.uniform4iv(V(a), u(), c >> 2, 4 * b); else {
                        if (72 >= b) for (var d = dc[4 * b - 1],
                                              f = 0; f < 4 * b; f += 4) d[f] = u()[c + 4 * f >> 2], d[f + 1] = u()[c + (4 * f + 4) >> 2], d[f + 2] = u()[c + (4 * f + 8) >> 2], d[f + 3] = u()[c + (4 * f + 12) >> 2]; else d = u().subarray(c >> 2, c + 16 * b >> 2);
                        U.uniform4iv(V(a), d)
                    }
                },
                emscripten_glUniformMatrix2fv: function (a, b, c, d) {
                    if (2 <= T.version) U.uniformMatrix2fv(V(a), !!c, w(), d >> 2, 4 * b); else {
                        if (72 >= b) for (var f = W[4 * b - 1], g = 0; g < 4 * b; g += 4) f[g] = w()[d + 4 * g >> 2], f[g + 1] = w()[d + (4 * g + 4) >> 2], f[g + 2] = w()[d + (4 * g + 8) >> 2], f[g + 3] = w()[d + (4 * g + 12) >> 2]; else f = w().subarray(d >> 2, d + 16 * b >> 2);
                        U.uniformMatrix2fv(V(a), !!c, f)
                    }
                },
                emscripten_glUniformMatrix3fv: function (a,
                                                         b, c, d) {
                    if (2 <= T.version) U.uniformMatrix3fv(V(a), !!c, w(), d >> 2, 9 * b); else {
                        if (32 >= b) for (var f = W[9 * b - 1], g = 0; g < 9 * b; g += 9) f[g] = w()[d + 4 * g >> 2], f[g + 1] = w()[d + (4 * g + 4) >> 2], f[g + 2] = w()[d + (4 * g + 8) >> 2], f[g + 3] = w()[d + (4 * g + 12) >> 2], f[g + 4] = w()[d + (4 * g + 16) >> 2], f[g + 5] = w()[d + (4 * g + 20) >> 2], f[g + 6] = w()[d + (4 * g + 24) >> 2], f[g + 7] = w()[d + (4 * g + 28) >> 2], f[g + 8] = w()[d + (4 * g + 32) >> 2]; else f = w().subarray(d >> 2, d + 36 * b >> 2);
            ...
            (function () {
                ...
                var d = {env: bd, wasi_snapshot_preview1: bd};
                ...
                (function () {
                    return Ea || "function" !== typeof WebAssembly.instantiateStreaming || $a() || I.startsWith("file://") || "function" !== typeof fetch ? c(b) : fetch(I, {credentials: "same-origin"}).then(function (f) {
            ...
            function ed() {
                function a() {
                    if (!cd && (cd = !0, y.calledRun = !0, !Ha)) {
                        ...
                        if (!B) {
                            if (y.postRun) for ("function" == typeof y.postRun && (y.postRun = [y.postRun]); y.postRun.length;) {
                ...
                if (!(0 < H)) if (B) la(y), B || db(Ua), postMessage({cmd: "loaded"}); else {
                    if (y.preRun) for ("function" == typeof y.preRun && (y.preRun = [y.preRun]); y.preRun.length;) Xa();
                    db(Ta);
            ...
            if (y.preInit) for ("function" == typeof y.preInit && (y.preInit = [y.preInit]); 0 < y.preInit.length;) y.preInit.pop()();
