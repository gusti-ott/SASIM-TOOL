                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child:
                                      stringMappingHelper.mapModeStringToIcon(
                                          trip.mode.toString()),
                                ),
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                            ...
                            BlocBuilder<InfoDropdownMobiscoreCubit,
                                InfoDropdownMobiscoreState>(
                              builder: (context, state) {
                                return ExpansionTile(
                                  ...
                                  subtitle:
                                      (state is InfoDropdownMobiscoreClosed)
                                          ? const Text(
                            ...
                            // Costs information
                            BlocBuilder<InfoDropdownCostsCubit,
                                InfoDropdownCostsState>(
                              builder: (context, state) {
                                return ExpansionTile(
                                  title: Row(
                                    mainAxisAlignment:
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        ExternalCostsDetailRow(
                                            ...
                                            externalCostValue: trip
                                                .costs.externalCosts.accidents,
                                            costIcon: Icons.emergency),
                                        ExternalCostsDetailRow(
                                            externalCostName: 'Klimaschäden',
                                            externalCostValue: trip
                                                .costs.externalCosts.climate,
                                            costIcon: Icons.eco),
                                        ExternalCostsDetailRow(
                                            externalCostName:
                                                'Luftverschmutzung',
                                        ...
                                        ExternalCostsDetailRow(
                                            ...
                                            externalCostValue: trip
                                                .costs.externalCosts.congestion,
                                            costIcon: Icons.traffic),
                                        ExternalCostsDetailRow(
                                            externalCostName: 'Barriereeffekte',
                                            externalCostValue: trip
                                                .costs.externalCosts.barrier,
